      ...
      <div className="seo py-8 bg-mustard">
        <div className="container mx-auto">
          <div className="grid grid-cols-2 gap-4">
            <div>
              <h3 className="font-custom mb-4 text-2xl leading-9 font-bold">
                STORIES, STYLES AND SPORTSWEAR AT ADIDAS, SINCE 1949
              </h3>
              <p className="font-custom color-black leading-6 text-md pb-4">
              ...
              <p className="font-custom color-black leading-6 text-md">
